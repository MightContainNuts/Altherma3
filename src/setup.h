...
#define WIFI_SSID "UmbrellaCorperation" //**Your SSID here**
#define WIFI_PWD "2478348124783481"     //**Your password here** leave empty if open (bad!)
...
#define MQTT_USERNAME "homeassistant"                                                    // leave empty if not set (bad!)
#define MQTT_PASSWORD "Fe0eiDah9auraThokooN3Pheecheizahshueheepaphut2ohquaesh0Peitae7oe" // leave empty if not set (bad!)
